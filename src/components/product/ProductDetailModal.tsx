...
import { ArrowLeft, Heart, Share2, Star, Check, Trash2, Plus, Minus, CheckCircle2, Sparkles, Package, ShieldCheck, Building2, Tag, X } from 'lucide-react';
  ...
  return (
    <div className="modal-backdrop product-detail-backdrop" onClick={onClose}>
      ...
      >
        ...
        {/* Main Scrollable Content (Responsive Split in Desktop) */}
        <div className="detail-scroll-content">
          <div className="detail-desktop-split-layout">
            {/* Left Column (Hero photo & badges) */}
            ...
            {/* Right Column (Info, options & instructions) */}
            <div className="detail-desktop-right">
              ...
              {product.sizes.length > 0 && (
                <div style={{ marginBottom: '20px' }}>
                  <h3 style={{ fontSize: '13.5px', fontWeight: 700, color: 'var(--text-secondary)', marginBottom: '10px' }}>
                    Opção de Embalagem / Quantidade
                  </h3>
                          ...
                          <div className="ingredient-left">
                            ...
                            <div className="ingredient-info">
                              ...
                              <span className="ingredient-portion">
                                {ingredient.portion} {ingredient.price > 0 ? `+${formatCurrency(ingredient.price)}` : 'Incluso'}
                              </span>
                            </div>
                          </div>
              ...
              <div style={{ marginBottom: '20px' }}>
                <h3 style={{ fontSize: '14px', fontWeight: 700, color: 'var(--text-primary)', marginBottom: '8px' }}>
                  Observações para a Separação / Pedido
                </h3>
                <textarea
                  value={specialInstructions}
                  onChange={e => setSpecialInstructions(e.target.value)}
                  placeholder="Ex: Fardo lacrado, embalar com cuidado extra, preferência de horário..."
                  style={{
                    width: '100%',
                    minHeight: '70px',
